...
final as (
    ...
    select 
        ...
        created_at,
        direction,
        cast( {{ twilio.remove_non_numeric_chars('duration')}} as {{ dbt.type_float() }}) as duration,
        end_time,
        forwarded_from,
        ...
        price_unit,
        cast( {{ twilio.remove_non_numeric_chars('queue_time')}} as {{ dbt.type_float() }}) as queue_time,
        start_time,
        status,
